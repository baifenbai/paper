...
<head>
    ...
    <link rel="stylesheet" href="/moudle/layui/layui.js "/>
    <style>
        body{margin: 10px;}
    ...
    <script>
        function copyText()
        {
            document.getElementById("tt").value="123";
        }
...
<button id="b" onclick="sendAjax()">点击我</button>
<div id="test"></div>
<input id="tt"/>
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            ...
            <div class="layui-carousel" id="test1">
                <div carousel-item>
                    <div><p class="layui-bg-green demo-carousel">在这里，你将以最直观的形式体验 layui！1111111</p></div>
...
<script src="//res.layui.com/layui/dist/layui.js?t=1515376178709"></script>
<script>
    layui.config({
